<template>
    <section>
        <div class="container">
                ...
                <div class="column is-narrow mt-n1">
                    <div class="buttons">
                        <b-tooltip label="Add New" type="is-dark">
                            <b-button type="is-text" size="is-large">
                                <i class="fa fa-plus"></i>
                            </b-button>
                        </b-tooltip>
                        <b-tooltip label="Search" type="is-dark">
            ...
            <h2 class="subtitle w-max-500"><strong>Graphical appearance</strong> of a user's character or persona to
                differentiate from the other players.</h2>
            <br>
            <b-table
                    :data="data"
                ...
                <template slot-scope="props">
                    <b-table-column field="id" label="ID" width="40" sortable numeric :searchable="searchable">
                        {{ props.row.id }}
                    </b-table-column>

                    <b-table-column field="user.first_name" label="First Name" sortable :searchable="searchable">
                        {{ props.row.user.first_name }}
                    </b-table-column>

                    <b-table-column field="user.last_name" label="Last Name" sortable :searchable="searchable">
                        {{ props.row.user.last_name }}
                    </b-table-column>

                    <b-table-column field="date" label="Date" sortable :searchable="searchable">
                <span class="tag is-success">
                    {{ new Date(props.row.date).toLocaleDateString() }}
                </span>
                    </b-table-column>

                    <b-table-column label="Gender" :searchable="searchable">
                <span>
                    <b-icon pack="fas"
